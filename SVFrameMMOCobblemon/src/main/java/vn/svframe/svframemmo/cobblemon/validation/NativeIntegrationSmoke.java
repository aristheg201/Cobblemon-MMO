...
public final class NativeIntegrationSmoke {
    public static void main(String[] args) {
        ...
        require(FusionService.DEFAULT_DANCE_DURATION_TICKS == 12_000L, "Default Fusion Dance duration must be 10 minutes");
        ...
        System.out.println("SVFrameMMO Cobblemon native integration smoke PASS");
    }

...
public final class NativeCoreSmoke {
    ...
    public static void main(String[] args)throws Exception{
        ...
        require(registry.item("ruby_gem").isGem(),"gem definition");require(registry.item("trailblazer_blade").stats().size()==2,"item stats");require(registry.rarity("rare").statMultiplier()>1d,"rarity multiplier");require(registry.revision()==1,"registry revision");require(registry.lootTable("starter_drops").entries().getFirst().rewardId().equals("item"),"loot reward");

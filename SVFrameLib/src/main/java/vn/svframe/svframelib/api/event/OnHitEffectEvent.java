...
public class OnHitEffectEvent extends MMOPlayerDataEvent {
    ...
    public OnHitEffectEvent call() { MythicLibEventHub.events().publish(this); return this; }
    public static AutoCloseable subscribe(Consumer<? super OnHitEffectEvent> listener) {
        return MythicLibEventHub.events().subscribe(OnHitEffectEvent.class, listener);
    }
}

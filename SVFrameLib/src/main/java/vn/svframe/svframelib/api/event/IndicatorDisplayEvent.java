...
public class IndicatorDisplayEvent {
 ...
 public void call(){SVFrameLibEventHub.events().publish(this);} public static AutoCloseable subscribe(Consumer<? super IndicatorDisplayEvent> l){return SVFrameLibEventHub.events().subscribe(IndicatorDisplayEvent.class,l);}
}

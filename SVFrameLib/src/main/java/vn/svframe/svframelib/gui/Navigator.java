package vn.svframe.svframelib.gui;
import vn.svframe.svframelib.api.player.MMOPlayerData; import net.minecraft.inventory.Inventory; import net.minecraft.server.network.ServerPlayerEntity;
import java.util.*;
public class Navigator {
    ...
    public boolean isClosed(){return closed;} public Inventory getLastPlatformOpened(){return lastOpened;} public Inventory getLastOpened(){return lastOpened;} public PluginInventory peek(){return openedInventories.peek();}

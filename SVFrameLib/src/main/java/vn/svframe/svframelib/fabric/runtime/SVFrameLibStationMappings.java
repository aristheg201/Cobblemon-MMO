...
/** Exact raw-slot mappings used by SVFrameLib 1.7.1 for vanilla crafting stations. */
public final class SVFrameLibStationMappings {
    public enum Kind { PLAYER_CRAFTING, WORKBENCH, FURNACE, SMITHING_LEGACY, SMITHING_MODERN }

    public record Mapping(
            Kind kind,
            SVFrameLibCraftingRuntime.Station station,
            int resultSlot,
            int[] mainSlots,

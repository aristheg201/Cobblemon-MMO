...
/** Damage type surface aligned with SVFrameLib 1.7.1. */
public enum DamageType {
    ...
    public static List<DamageType> listFromConfig(Object raw) {
        ...
        if (raw instanceof Iterable<?> values) {
            ...
            for (Object value : values) result.add(parse(String.valueOf(value)));
            return result;
        }
    ...
    private static DamageType parse(String value) {
        ...
        if (normalized.equals("MAGICAL")) normalized = "MAGIC";
        try {

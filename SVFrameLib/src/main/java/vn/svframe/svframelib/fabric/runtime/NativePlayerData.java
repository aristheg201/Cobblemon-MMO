...
import vn.svframe.svframelib.fabric.runtime.session.CooldownMapRuntime;
import vn.svframe.svframelib.fabric.runtime.session.SVFramePlayerSessionRuntime;
import vn.svframe.svframelib.fabric.runtime.session.ProfileSessionRuntime;
...
/** Native Fabric player-data object replacing SVFrameLib 1.7.1 MMOPlayerData's server-plugin platform player binding. */
public final class NativePlayerData {
    ...
    private final SVFramePlayerSessionRuntime sessions;
    ...
    public NativePlayerData(boolean lookup, UUID entityId) {
        ...
        this.sessions = new SVFramePlayerSessionRuntime(lookup, System::currentTimeMillis, Set.of());

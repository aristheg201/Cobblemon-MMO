package vn.svframe.svframelib.fabric.runtime.session;
...
/** Native Fabric player/profile session runtime preserving SVFrameLib 1.7.1 lifecycle semantics. */
public final class SVFramePlayerSessionRuntime {
    ...
    public SVFramePlayerSessionRuntime(boolean lookup, LongSupplier clock, Set<String> modules) {
        this.lookup = lookup;
        this.clock = clock;

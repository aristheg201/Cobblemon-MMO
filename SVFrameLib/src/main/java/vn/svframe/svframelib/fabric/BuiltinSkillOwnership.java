...
/** Exact SVFrameLib 1.7.1 ownership split for bundled default:* skill IDs. */
public final class BuiltinSkillOwnership {
    ...
    static {
        if (NATIVE_IDS.size() != 90) throw new ExceptionInInitializerError("Expected 90 SVFrameLib native built-ins, got " + NATIVE_IDS.size());

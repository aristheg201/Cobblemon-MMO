...
/**
 * Fabric-side counterpart of SVFrameLib's legacy TriggerType registry.
 *
 * The IDs deliberately match the server-plugin platform implementation so existing SVFrameItems/
 * SVFrameMMO configuration and bridges do not need a second naming scheme.
 */

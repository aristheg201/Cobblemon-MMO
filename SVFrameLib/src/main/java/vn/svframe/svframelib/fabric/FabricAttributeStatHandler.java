...
/** Native Fabric counterpart of SVFrameLib 1.7.1 AttributeStatHandler. */
public class FabricAttributeStatHandler extends NativeStatHandler {
    private static final Identifier ATTRIBUTE_KEY = Identifier.of(SVFrameLibFabricMod.ID, "main");
    ...
    public FabricAttributeStatHandler(String stat,
                                      ...
                                      SVFrameLibStatSettings.Entry settings) {

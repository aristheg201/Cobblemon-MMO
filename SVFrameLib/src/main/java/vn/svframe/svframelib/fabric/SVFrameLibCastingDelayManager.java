...
/** Native server-tick replacement for SVFrameLib 1.7.1 CastingDelayHandler scheduling. */
public final class SVFrameLibCastingDelayManager {
    private static final Map<UUID, Cast> CASTS = new ConcurrentHashMap<>();

    private SVFrameLibCastingDelayManager() { }

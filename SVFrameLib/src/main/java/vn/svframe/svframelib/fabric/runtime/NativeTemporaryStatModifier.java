...
/** Native Fabric implementation of SVFrameLib 1.7.1 TemporaryStatModifier lifecycle. */
public final class NativeTemporaryStatModifier extends NativeStatModifier implements AutoCloseable {
    ...
    /** Called from the Fabric server tick. Matches server-plugin platform runTaskLater execution at the due tick. */

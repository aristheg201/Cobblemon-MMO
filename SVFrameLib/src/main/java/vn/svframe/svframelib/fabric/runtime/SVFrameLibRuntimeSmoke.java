...
import vn.svframe.svframelib.fabric.runtime.skill.*;
import vn.svframe.svframelib.config.YamlLite;
import java.util.Map;
import vn.svframe.svframelib.fabric.runtime.script.*;

public final class SVFrameLibRuntimeSmoke {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("SVFRAMELIB_NATIVE_RUNTIME=PASS");
    }

...
public interface ScriptPlatform {
    ...
    boolean isLiving(UUID target);
    boolean isOnFire(UUID target);
    boolean hasPermission(UUID player, String permission);
    boolean isCreative(UUID player);
    int foodLevel(UUID player);
    void setFoodLevel(UUID player, int value);
    void setSaturation(UUID player, float value);
    String worldName(UUID reference);
    String biome(UUID reference, Vector3 location);
    ...
    void teleport(UUID target, Vector3 location);
    ...
    void message(UUID target, String message);
    void kick(UUID target, String message);
    void closeInventory(UUID target);
    void dispatchCommand(UUID target, String command, boolean fromConsole, boolean operator);
    void lightning(UUID reference, Vector3 location, boolean cosmetic);
    void giveItem(UUID player, String item, int amount);
    ...
    boolean cooldownReady(UUID player, String path);
    void applyCooldown(UUID player, String path, double seconds);
    void reduceCooldown(UUID player, String path, String reduction, double value);
    void addStat(UUID player, String stat, String key, double value, boolean relative, boolean unique, long lifetimeTicks);
    void removeStat(UUID player, String stat, String key);

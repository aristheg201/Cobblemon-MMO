...
/** Exact native Fabric implementations for MythicLib 1.7.1 target/status built-ins. */
    ...
    private static void playBurnHelix(ServerWorld world, Vec3d origin) {
        final class BurnHelix implements Runnable {
            ...
            public void run() {
                ...
                if (y < 1.7d) MythicLibFabricMod.schedule(1, this);
            }
        }
        MythicLibFabricMod.schedule(0, new BurnHelix());
    }
    ...
    private static void playSlowSpiral(ServerWorld world, Vec3d origin) {
        final class SlowSpiral implements Runnable {
            ...
            public void run() {
                ...
                if (time < Math.PI * 2.0d) MythicLibFabricMod.schedule(1, this);
            }
        }
        MythicLibFabricMod.schedule(0, new SlowSpiral());
    }

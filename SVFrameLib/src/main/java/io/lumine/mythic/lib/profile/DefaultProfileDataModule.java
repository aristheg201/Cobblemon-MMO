...
import io.lumine.mythic.lib.data.SynchronizedDataManager; import io.lumine.mythic.lib.module.MMOPlugin; import net.minecraft.util.Identifier; import java.util.*;
public class DefaultProfileDataModule {
    ...
    @SuppressWarnings({"rawtypes","unchecked"}) private static void load(SynchronizedDataManager manager,Object data){manager.loadData((io.lumine.mythic.lib.data.SynchronizedDataHolder)data);}
    @SuppressWarnings({"rawtypes","unchecked"}) private static void save(SynchronizedDataManager manager,Object data,SessionUpdateReason reason){manager.saveData((io.lumine.mythic.lib.data.SynchronizedDataHolder)data,reason);}

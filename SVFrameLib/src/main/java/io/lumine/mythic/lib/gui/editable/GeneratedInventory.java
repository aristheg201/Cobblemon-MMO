...
import io.lumine.mythic.lib.gui.*; import io.lumine.mythic.lib.gui.editable.item.*; import net.minecraft.inventory.*; import net.minecraft.item.ItemStack;
...
public abstract class GeneratedInventory extends PluginInventory {
    ...
    @Override public void onClose(){} @Override public String getTitle(){return bakeName();} public String getRawName(){return guiName;} public String bakeName(){return applyNamePlaceholders(guiName);} public String applyNamePlaceholders(String s){return s==null?"":s.replace("{page}",String.valueOf(page+1));}

...
/**
 * Fabric-native MythicLib 1.7.1 service facade.  The original static singleton
 * contract is intentionally retained so MMOCore/MMOItems can link unchanged.
 */
public class MythicLib extends MMOPlugin {
    ...
    private static ProfileHandler emptyProfileHandler(){return new ProfileHandler(){

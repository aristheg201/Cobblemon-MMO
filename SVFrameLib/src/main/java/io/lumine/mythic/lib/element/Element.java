...
import vn.svframe.mythiclibfabric.MythicLibCombatRuntime;
...
public final class Element {
    ...
    public static Collection<Element> values(){List<Element>out=new ArrayList<>();for(NativeElementRegistry.Element e:MythicLibCombatRuntime.elements().values())out.add(new Element(e));return List.copyOf(out);}public static Element valueOf(String id){NativeElementRegistry.Element e=MythicLibCombatRuntime.elements().get(id);if(e==null)throw new IllegalArgumentException("Unknown element: "+id);return new Element(e);}

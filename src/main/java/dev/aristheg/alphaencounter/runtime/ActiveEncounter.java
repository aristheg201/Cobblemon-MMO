...
public final class ActiveEncounter {
    ...
    public float maxHp = -1f, hp = -1f;
    public EncounterState state = EncounterState.IDLE;
    public UUID targetPlayer, pendingBattlePlayer, lastBattlePlayer;
    public long battleAtTick, pendingSinceTick, nextReengageTick, nextFieldAttackTick, nextPathRefreshTick, missingSinceTick;
    public int lastPokemonHealth = -1, battleLocalMax = -1;
